...
class TPCHBenchmark : public benchmark::Fixture {
 public:
  ...
  const std::string tpch_table_root_ = "../../../../Data/NP-TPCH/SF1/";
  ...
  void SetUp(const benchmark::State &state) final {
    ...
    tpch_workload_ =
        std::make_unique<tpch::Workload>(common::ManagedPointer<DBMain>(db_main_), tpch_database_name_, tpch_table_root_, Workload::BenchmarkType::TPCH);
  }
